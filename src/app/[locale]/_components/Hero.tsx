          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 lg:space-x-6">
              <a
                ...
                className="flex items-center bg-[#1A7D3D] text-white font-medium rounded-full px-6 lg:px-8 py-2.5 lg:py-4 text-base lg:text-lg transition-all transform hover:scale-105 hover:shadow-lg hover:bg-[#166534]"
              >
                {isClient ? (
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center border-2 border-[#1A7D3D] text-[#1A7D3D] font-medium rounded-full px-6 lg:px-8 py-2.5 lg:py-4 text-base lg:text-lg transition-all hover:bg-[#1A7D3D]/5"
              >
                {isClient ? (
