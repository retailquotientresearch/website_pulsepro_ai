...
export default function StepByStepProcess() {
  ...
  return (
    <Section className="bg-gradient-to-br from-gray-200 via-gray-100 to-white dark:from-gray-900 dark:via-gray-950 dark:to-black" padding="xl">
      <Container>
          ...
          <div className="inline-block mb-4">
            <div className="bg-gradient-to-br from-gray-300 via-gray-200 to-gray-400 dark:from-gray-700 dark:via-gray-600 dark:to-gray-500 backdrop-blur-sm rounded-full px-6 py-3 shadow-sm">
              <span className="text-gray-700 dark:text-gray-300 font-semibold">
                <i className="ri-route-line text-gray-600 dark:text-gray-400 text-xl font-bold mr-2"></i>
                Step by Step
              </span>
            </div>
          </div>
