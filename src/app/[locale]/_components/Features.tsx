      ...
      <Container>
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            {t("subtitle.part1")}{" "}
            <span className="font-bold">{t("subtitle.highlight")}</span>{" "}
            {t("subtitle.part2")}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-6 mb-8 max-w-sm mx-auto md:max-w-none">
          {featureConfig.map((feature, index) => {
            ...
            return (
              ...
              >
                <Card
                  className={`group cursor-pointer rounded-2xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-2xl hover:rotate-2 md:hover:scale-105 hover:scale-[1.02] transition-all duration-500 ease-in-out transform origin-bottom-right ${
                    isSelected
                ...
                >
                  <CardContent className="flex items-center p-4">
                    ...
                    <CardTitle className="font-medium flex-1">
                      {t(`items.${index}.title`)}
                    </CardTitle>
                  </CardContent>
                </Card>
        ...
        {selectedFeature !== null && (
          <div className="w-full max-w-sm mx-auto md:max-w-none mt-8 z-10">
            <Card className="transition-all duration-300 animate-in slide-in-from-top-4 rounded-[2.5rem] border border-gray-200 dark:border-gray-600 bg-gradient-to-br from-white via-gray-50 to-white dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 shadow-2xl">
              <CardContent
              ...
              >
                <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8 lg:gap-10">
                  <div
                    className={`w-20 h-20 lg:w-24 lg:h-24 ${featureConfig[selectedFeature].gradient} rounded-2xl flex items-center justify-center animate-in zoom-in-50 duration-300 shadow-md`}
                  >
                    <i
