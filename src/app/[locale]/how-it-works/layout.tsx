...
export const metadata: Metadata = {
  title: 'How It Works',
  description:
    'See how PulsePro.ai works in 4 steps: capture findings on mobile, verify results, generate instant reports, and drive continuous improvement across all your sites.',
  openGraph: {
    title: 'How PulsePro.ai Works | Enterprise Inspection Platform',
    description:
